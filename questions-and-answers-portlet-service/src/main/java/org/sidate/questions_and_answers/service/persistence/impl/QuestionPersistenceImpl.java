...
import org.sidate.questions_and_answers.exception.NoSuchQuestionException;
import org.sidate.questions_and_answers.model.Question;
import org.sidate.questions_and_answers.model.impl.QuestionImpl;
import org.sidate.questions_and_answers.model.impl.QuestionModelImpl;
import org.sidate.questions_and_answers.service.persistence.QuestionPersistence;
import org.sidate.questions_and_answers.service.persistence.QuestionUtil;
...
public class QuestionPersistenceImpl extends BasePersistenceImpl<Question>
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((question.getUuid() == null) ||
							!question.getUuid().equals(uuid) ||
							(question.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, question);
					}
				}
	...
	protected Question toUnwrappedModel(Question question) {
		...
		questionImpl.setText(question.getText());
		questionImpl.setCorrectAnswerId(question.getCorrectAnswerId());
